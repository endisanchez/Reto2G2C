...
$sql="SELECT id, nombre, descripcion, imagen, enlaces_videos FROM productos";
...
<article>
	...
	<?php while ($row=$result->fetch_assoc()) { ?>
		...
		<table id="taula">
  			<tr>
    			<td><?php echo "<img src='./Imagenes/" . $row['imagen'] . "' width='250' ></img>"; ?></td>
    			<td><?php echo "<u>" . $row['nombre'] . "</u>" . "<br><br>" . $row['descripcion']; ?></td>
